...
class GalaxeaA1(ManipulatorModel):
    """
    ...
    def __init__(self, idn=0):
        super().__init__(robosuite_model_path_completion("robots/galaxea_a1/robot.xml"), idn=idn)
    ...
    @property
    def init_qpos(self):
        return np.array([0.0, 0.5, -0.5, 1.57, 0.0, -1.57])
